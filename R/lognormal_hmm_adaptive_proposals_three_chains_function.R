#' Function to run overall MCMC algorithm.
#'
...
#' 100.
#' @param adapt.chain.length Number of MCMC iterations to run in each iteration of
#' adaptive phase. Default is 100.
#' @return List of supplied parameters and results. Length of final MCMC runs
...
ln_hmm_adapt_3_chains <- function(counts,
  ...
  means0 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.means0.1),
                            coda::mcmc(final.chains$posterior.means0.2),
                            coda::mcmc(final.chains$posterior.means0.3))
  means1 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.means1.1),
                            coda::mcmc(final.chains$posterior.means1.2),
                            coda::mcmc(final.chains$posterior.means1.3))
  means2 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.means2.1),
                            coda::mcmc(final.chains$posterior.means2.2),
                            coda::mcmc(final.chains$posterior.means2.3))
  disps0 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.disps0.1),
                            coda::mcmc(final.chains$posterior.disps0.2),
                            coda::mcmc(final.chains$posterior.disps0.3))
  disps1 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.disps1.1),
                            coda::mcmc(final.chains$posterior.disps1.2),
                            coda::mcmc(final.chains$posterior.disps1.3))
  disps2 <- coda::mcmc.list(coda::mcmc(final.chains$posterior.disps2.1),
                            coda::mcmc(final.chains$posterior.disps2.2),
                            coda::mcmc(final.chains$posterior.disps2.3))
  mean.prior.location <- coda::mcmc.list(
    coda::mcmc(final.chains$posterior.mean.prior.location.1),
    coda::mcmc(final.chains$posterior.mean.prior.location.2),
    coda::mcmc(final.chains$posterior.mean.prior.location.3)
    )
  mean.prior.scale <- coda::mcmc.list(
    coda::mcmc(final.chains$posterior.mean.prior.scale.1),
    coda::mcmc(final.chains$posterior.mean.prior.scale.2),
    coda::mcmc(final.chains$posterior.mean.prior.scale.3)
    )
  disp.prior.location <- coda::mcmc.list(
    coda::mcmc(final.chains$posterior.disp.prior.location.1),
    coda::mcmc(final.chains$posterior.disp.prior.location.2),
    coda::mcmc(final.chains$posterior.disp.prior.location.3)
    )
  disp.prior.scale <- coda::mcmc.list(
    coda::mcmc(final.chains$posterior.disp.prior.scale.1),
    coda::mcmc(final.chains$posterior.disp.prior.scale.2),
    coda::mcmc(final.chains$posterior.disp.prior.scale.3)
    )
  indicators <- coda::mcmc.list(coda::mcmc(final.chains$posterior.indicators.1),
                                coda::mcmc(final.chains$posterior.indicators.2),
                                coda::mcmc(final.chains$posterior.indicators.3))
  proportion <- coda::mcmc.list(coda::mcmc(final.chains$posterior.proportion.1),
                                coda::mcmc(final.chains$posterior.proportion.2),
                                coda::mcmc(final.chains$posterior.proportion.3))
  rm(final.chains)
